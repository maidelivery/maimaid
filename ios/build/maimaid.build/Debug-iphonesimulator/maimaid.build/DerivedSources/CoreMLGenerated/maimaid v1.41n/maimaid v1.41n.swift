...
class maimaid_v1_41nInput : MLFeatureProvider {
...
@available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
class maimaid_v1_41nOutput : MLFeatureProvider {
...
@available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
class maimaid_v1_41n {
    let model: MLModel

    /// URL of model assuming it was installed in the same bundle as this class
    class var urlOfModelInThisBundle : URL {
        let bundle = Bundle(for: self)
        return bundle.url(forResource: "maimaid v1.41n", withExtension:"mlmodelc")!
    }

    /**
        Construct maimaid_v1_41n instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of maimaid_v1_41n.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `maimaid_v1_41n.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct maimaid_v1_41n instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct maimaid_v1_41n instance asynchronously with optional configuration.
    ...
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<maimaid_v1_41n, any Error>) -> Void) {
    ...
    /**
        ...
        - parameters:
          - configuration: the desired model configuration
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> maimaid_v1_41n {
        try await load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct maimaid_v1_41n instance asynchronously with URL of the .mlmodelc directory with optional configuration.
        ...
        - parameters:
          ...
          - handler: the completion handler to be called when the model loading completes successfully or unsuccessfully
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<maimaid_v1_41n, any Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(maimaid_v1_41n(model: model)))
            }
        }
    }
    ...
    /**
        ...
        - parameters:
          ...
          - configuration: the desired model configuration
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> maimaid_v1_41n {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return maimaid_v1_41n(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as maimaid_v1_41nInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as maimaid_v1_41nOutput
    */
    func prediction(input: maimaid_v1_41nInput) throws -> maimaid_v1_41nOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as maimaid_v1_41nOutput
    */
    func prediction(input: maimaid_v1_41nInput, options: MLPredictionOptions) throws -> maimaid_v1_41nOutput {
        let outFeatures = try model.prediction(from: input, options: options)
        return maimaid_v1_41nOutput(features: outFeatures)
    }
    ...
    */
    ...
    func prediction(input: maimaid_v1_41nInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> maimaid_v1_41nOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as maimaid_v1_41nOutput
    */
    func prediction(image: CVPixelBuffer, iouThreshold: Double, confidenceThreshold: Double) throws -> maimaid_v1_41nOutput {
        let input_ = maimaid_v1_41nInput(image: image, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [maimaid_v1_41nInput]
           - options: prediction options
        ...
        - returns: the result of the prediction as [maimaid_v1_41nOutput]
    */
    func predictions(inputs: [maimaid_v1_41nInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [maimaid_v1_41nOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [maimaid_v1_41nOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  maimaid_v1_41nOutput(features: outProvider)

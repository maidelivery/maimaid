...
#ifndef MAIMAID_SWIFT_H
#define MAIMAID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="maimaid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7maimaid20CameraViewController")
...
@interface CameraViewController (SWIFT_EXTENSION(maimaid)) <AVCapturePhotoCaptureDelegate>

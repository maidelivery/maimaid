...
struct ThemeUtils {
    ...
    static func bestFC(_ firstStatus: String?, _ secondStatus: String?) -> String? {
        if fcOrder(firstStatus) >= fcOrder(secondStatus) { return firstStatus }
        return secondStatus
    }
    ...
    static func bestFS(_ firstStatus: String?, _ secondStatus: String?) -> String? {
        if fsOrder(firstStatus) >= fsOrder(secondStatus) { return firstStatus }
        return secondStatus
    }

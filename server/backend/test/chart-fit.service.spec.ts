...
const makeChart = (overrides?: Partial<{
  cnt: number;
  diff: string;
  fit_diff: number;
  avg: number;
...
describe("chart fit payload normalization and merge", () => {
  ...
  it("applies secondary cnt threshold before weighted merge", () => {
    const primary = {
      charts: {
        "100": [
          makeChart({ cnt: 2000, fit_diff: 13.5, avg: 98.0, dist: [0, 0, 0, 0, 0, 0, 0, 0, 20, 30, 40, 50, 800, 1060] }),
        ],
      },
      diff_data: {},
    };
    ...
    const secondaryUnderThreshold = {
      charts: {
        "100": [
          makeChart({ cnt: 999, fit_diff: 14.8, avg: 99.7 }),
        ],
      },
      diff_data: {},
    };
    ...
    const secondaryUsed = {
      charts: {
        "100": [
          makeChart({ cnt: 1000, fit_diff: 14.5, avg: 99.0, dist: [0, 0, 0, 0, 0, 0, 0, 0, 10, 10, 20, 30, 300, 630] }),
        ],
      },
      diff_data: {},
    };

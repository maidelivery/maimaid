...
export const useDashboardStore = create<DashboardStore>((set) => ({
  ...
  setSessionBootstrapped: (next) => set((state) => ({ sessionBootstrapped: resolveStateUpdate(next, state.sessionBootstrapped) })),
  ...
  setCatalogVersionItems: (next) => set((state) => ({ catalogVersionItems: resolveStateUpdate(next, state.catalogVersionItems) })),
  ...
  setSongDetailChartType: (next) => set((state) => ({ songDetailChartType: resolveStateUpdate(next, state.songDetailChartType) })),
  ...
  setCommunityDailyCount: (next) => set((state) => ({ communityDailyCount: resolveStateUpdate(next, state.communityDailyCount) })),
  setMyCandidateSongName: (next) => set((state) => ({ myCandidateSongName: resolveStateUpdate(next, state.myCandidateSongName) })),
  ...
  setAdminCandidateStatus: (next) => set((state) => ({ adminCandidateStatus: resolveStateUpdate(next, state.adminCandidateStatus) })),
  setAdminStats: (next) => set((state) => ({ adminStats: resolveStateUpdate(next, state.adminStats) })),
  setCandidateVoteCloseDrafts: (next) => set((state) => ({ candidateVoteCloseDrafts: resolveStateUpdate(next, state.candidateVoteCloseDrafts) })),
  ...
  setStaticBundleSchedule: (next) => set((state) => ({ staticBundleSchedule: resolveStateUpdate(next, state.staticBundleSchedule) })),
  ...
  setNewStaticFallbackUrls: (next) => set((state) => ({ newStaticFallbackUrls: resolveStateUpdate(next, state.newStaticFallbackUrls) })),
  resetForSignedOut: () =>
    set(() => ({
      profiles: [],
      activeProfileId: "",

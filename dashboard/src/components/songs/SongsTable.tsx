            ...
            <article key={song.songIdentifier} className="rounded-lg border p-3">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">{t("tableColVersion")}：{formatVersionDisplay(song.version)}</p>
                </div>
                <Button
                  variant="ghost"
                  size="icon-lg"
            ...
            {pagination.pagedItems.map((song) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="hidden max-w-[220px] truncate sm:table-cell">{formatVersionDisplay(song.version)}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
